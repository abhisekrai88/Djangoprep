# Generated by Django 3.1.5 on 2021-01-20 19:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, max_length=1, null=True, verbose_name='Gender (M/F)')),
                ('dob', models.DateField(blank=True, null=True, verbose_name='Date of Birth')),
                ('joined', models.DateField(blank=True, null=True, verbose_name='Joined Date')),
                ...
                ('salary', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default_currency='SGD', max_digits=14, null=True, verbose_name='Salary')),
                ('Active', models.BooleanField(default=False)),
                ('department', models.CharField(blank=True, choices=[('MANAGEMENT', 'MANAGEMENT'), ('BUSINESS DEVELOPMENT', 'BUSINESS DEVELOPMENT'), ('HUMAN RESOURCES', 'HUMAN RESOURCES'), ('PRODUCT MANAGEMENT', 'PRODUCT MANAGEMENT')], max_length=50, null=True, verbose_name='Department')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
            fields=[
                ...
                ('department', models.CharField(blank=True, choices=[('MANAGEMENT', 'MANAGEMENT'), ('BUSINESS DEVELOPMENT', 'BUSINESS DEVELOPMENT'), ('HUMAN RESOURCES', 'HUMAN RESOURCES'), ('PRODUCT MANAGEMENT', 'PRODUCT MANAGEMENT')], max_length=50, null=True, verbose_name='Department')),
                ('Active', models.BooleanField(default=False)),
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_name', to='myapi.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Appraisal',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grade', models.CharField(blank=True, choices=[('EXCELLENT', 'EXCELLENT'), ('GOOD', 'GOOD'), ('AVERAGE', 'AVERAGE'), ('POOR', 'POOR')], max_length=20, null=True, verbose_name='Performace Grade')),
                ('year', models.IntegerField(blank=True, null=True, verbose_name='Year')),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapi.employee')),
            ],
        ),
    ]
